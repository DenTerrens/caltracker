...
# user's request - API shows even partial phrase matches - fixed in the list of results
food = input('Enter name of the product: ').lower().strip()
